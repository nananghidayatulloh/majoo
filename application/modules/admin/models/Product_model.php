...
class Product_model extends CI_Model {
    ...
    var $table = 'products';
    var $column_order = array(null, 'products.id','products.name','products.price','products.is_available','products.product_name','product_category.name','product_category.id'); //set column field database for datatable orderable
    var $column_search = array('products.id','products.name','products.price','products.is_available','products.product_name','product_category.name','product_category.id'); //set column field database for datatable searchable 
      ...
      private function _get_datatables_query()
    {
        ...
        $this->db->select('products.id, products.name, products.description, products.price, products.stock, products.product_unit, products.is_available,products.picture_name,product_category.id as category_id, product_category.name as category_name');
        $this->db->from('products');
        $this->db->join('product_category','product_category.id = products.category_id');
        //$this->db->where('m_products.Status', 'active');
